...
<script type="text/babel">
  ...
  import Focus from 'beescm-ui/src/mixins/focus';
  ...
  import ElScrollbar from 'beescm-ui/packages/scrollbar';
  ...
  import scrollIntoView from 'beescm-ui/src/utils/scroll-into-view';
  import { getValueByPath } from 'beescm-ui/src/utils/util';

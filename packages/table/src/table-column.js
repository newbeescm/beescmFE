...
import ElTag from 'beescm-ui/packages/tag';
import objectAssign from 'beescm-ui/src/utils/merge';
import { getPropByPath } from 'beescm-ui/src/utils/util';
...
const forced = {
  ...
  expand: {
    ...
    renderCell: function(h, { row, store }, proxy) {
      ...
      return <div class={ 'el-table__expand-icon ' + (expanded ? 'el-table__expand-icon--expanded' : '') } on-click={ e => proxy.handleExpandClick(row, e) }>

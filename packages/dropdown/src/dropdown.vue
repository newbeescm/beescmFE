<script>
  ...
  import Migrating from 'beescm-ui/src/mixins/migrating';
  import ElButton from 'beescm-ui/packages/button';
  import ElButtonGroup from 'beescm-ui/packages/button-group';
  import { generateId } from 'beescm-ui/src/utils/util';
